...
import { Link } from "react-router-dom"
  ...
  return (
    <div className='p-7 text-2xl font-semibold h-screen flex flex-col justify-between'>
      ...
      <p className="font-normal text-xl text-center mt-2">New Here, <Link to='/signup' className="text-blue-800">Register First!</Link></p>
      </div>
      <div>
      <Link to='/captain-login' className='flex items-center justify-center text-white rounded bg-emerald-500 w-full mt-5 h-14'>Sign In As Captain</Link>
      </div>
    </div>
  )
}
