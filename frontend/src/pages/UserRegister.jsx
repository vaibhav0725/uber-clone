...
const UserRegister = () => {
  ...
  return (
    <div className='p-7 text-2xl font-semibold h-screen flex flex-col justify-between'>
      ...
      <p className="font-normal text-xl text-center mt-2">Already Signed Up, <Link to='/login' className="text-blue-800">Login!</Link></p>
      </div>
      <div>
      <Link to='/captain-signup' className='flex items-center justify-center text-white rounded bg-emerald-500 w-full mt-5 h-14'>Register As Captain</Link>
      </div>
    </div>
  )
}
